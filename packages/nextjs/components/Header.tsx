...
import MeetupNav from "./(HomePage)/MeetupNav";
        ...
        return (
          <li key={href}>
            <Link
              ...
              } hover:bg-secondary font-light hover:shadow-md focus:!bg-secondary active:!text-neutral py-1.5 px-3 text-sm rounded-full gap-2 grid grid-flow-col`}
            >
              {icon}
              <span>{label}</span>
            </Link>
